...
with open(tempfile, 'w') as f:
  for ds in datasets:
    ...
    f.write("\n")
    f.write('''<div class="spotlight">
                  <div class="content">
                    <header class="major">
                      <h3>'''+ds["Contest"]+'''</h3>
                    </header>
                    <p>'''+ds['About']+'''</p>
                    <h6><b>Applications Open: </b>'''+ds['Application Open']+'''</h6>
                    <h6><b>Applications Close: </b>'''+ds["Last Date to Apply"]+'''</h6>
                    <h6><b>Eligibiblity: </b>'''+ds['Eligibiblity']+'''</h6>
