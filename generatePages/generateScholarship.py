import os
from scholarship import datasets

startComment = "START AUTO-INSERT DATASETS"
endComment = "END AUTO-INSERT DATASETS"
pageToChange = "../scholarships.html"
tempfile = 'scholarship.temp'
...
with open(tempfile, 'w') as f:
  for ds in datasets:
    print("Adding dataset for "+ds["Scholarship"])
    f.write("\n")
    f.write('''
                <div class="spotlight">
                  <div class="content">
                    <h2>'''+ds["Scholarship"]+'''</h2>
                    <p>'''+ds['About']+'''</p>
                    <h6><b>Applications Open: </b>'''+ds['Applications open']+'''</h6>
                    <h6><b>Applications Close: </b>'''+ds["Application Close"]+'''</h6>
                    <h6><b>Eligibiblity: </b>'''+ds['Eligibility']+'''</h6>
                    <h6><b>Benefits: </b>'''+ds['Benefits']+'''</h6>
                    <ul class="actions">
